...
with open("config/cfg_g.json5", "r", encoding="utf-8") as file:
    cfg = json5.load(file)
with open("config/prmpt_de.json5", "r", encoding="utf-8") as file:
    prt = json5.load(file)

mdl = cfg["MODEL_G"]
s_i = prt["PRM_C"]

s_i = s_i.replace("**", "british english")


ptf = "D:/gthb/bks/aiv/de/OEBPS/text/*.xhtml"

pto = "D:/gthb/bks/aiv/de/OEBPS/text/"

bgn = end = "9780063347502_Chapter01"
